# Comparing `tmp/Pandora-Cloud-0.4.2.tar.gz` & `tmp/Pandora-Cloud-0.4.3.tar.gz`
...
### Comparing `Pandora-Cloud-0.4.2/LICENSE` & `Pandora-Cloud-0.4.3/LICENSE`
 ...
 ****** Welcome Back ******
 ...
 Password[********************]
 Password
 Show passwordHide passwordShow passwordHide password
...
### Comparing `Pandora-Cloud-0.4.2/src/pandora_cloud/flask/templates/share.html` & `Pandora-Cloud-0.4.3/src/pandora_cloud/flask/templates/share.html`

 * *Files identical despite different names*

### Comparing `Pandora-Cloud-0.4.2/src/pandora_cloud/server.py` & `Pandora-Cloud-0.4.3/src/pandora_cloud/server.py`
