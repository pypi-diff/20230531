# Comparing `tmp/csle_rest_api-0.2.2.tar.gz` & `tmp/csle_rest_api-0.2.3.tar.gz`
...
### Comparing `csle_rest_api-0.2.2/pyproject.toml` & `csle_rest_api-0.2.3/pyproject.toml`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/setup.cfg` & `csle_rest_api-0.2.3/setup.cfg`
...
### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/constants/constants.py` & `csle_rest_api-0.2.3/src/csle_rest_api/constants/constants.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/about/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/about/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/container_terminal/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/container_terminal/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/control_plane/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/control_plane/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/downloads/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/downloads/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/emulation_statistics/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/emulation_statistics/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/emulations/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/emulations/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/images/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/images/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/jobs/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/jobs/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/login/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/login/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/logs_admin/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/logs_admin/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/monitoring/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/monitoring/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/policy_examination/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/policy_examination/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/register/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/register/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/sdn_controllers/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/sdn_controllers/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/server_cluster/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/server_cluster/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/simulations/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/simulations/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/system_admin/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/system_admin/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/system_models/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/system_models/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/traces/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/traces/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/training/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/training/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/pages/user_admin/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/pages/user_admin/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/alpha_vec_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/alpha_vec_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/cadvisor/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/cadvisor/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/cluster_status/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/cluster_status/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/config/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/config/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/data_collection_jobs/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/data_collection_jobs/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/docker/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/docker/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/dqn_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/dqn_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/empirical_system_models/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/empirical_system_models/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/emulation_executions/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/emulation_executions/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/emulation_simulation_traces/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/emulation_simulation_traces/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/emulation_statistics/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/emulation_statistics/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/emulation_traces/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/emulation_traces/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/emulations/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/emulations/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/experiments/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/experiments/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/file/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/file/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/flask/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/flask/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/fnn_w_softmax_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/fnn_w_softmax_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/gaussian_mixture_system_models/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/gaussian_mixture_system_models/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/gp_system_models/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/gp_system_models/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/grafana/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/grafana/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/images/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/images/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/linear_threshold_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/linear_threshold_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/login/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/login/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/logs/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/logs/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/multi_threshold_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/multi_threshold_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/nginx/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/nginx/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/node_exporter/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/node_exporter/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/pgadmin/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/pgadmin/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/postgresql/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/postgresql/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/ppo_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/ppo_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/prometheus/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/prometheus/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/sdn_controllers/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/sdn_controllers/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/server_cluster/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/server_cluster/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/simulation_traces/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/simulation_traces/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/simulations/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/simulations/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/statistics_datasets/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/statistics_datasets/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/system_identification_jobs/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/system_identification_jobs/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/system_models/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/system_models/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/tabular_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/tabular_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/traces_datasets/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/traces_datasets/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/training_jobs/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/training_jobs/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/users/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/users/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/vector_policies/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/vector_policies/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/resources/version/routes.py` & `csle_rest_api-0.2.3/src/csle_rest_api/resources/version/routes.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/rest_api.py` & `csle_rest_api-0.2.3/src/csle_rest_api/rest_api.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/util/rest_api_util.py` & `csle_rest_api-0.2.3/src/csle_rest_api/util/rest_api_util.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api/web_sockets/container_terminal/container_terminal.py` & `csle_rest_api-0.2.3/src/csle_rest_api/web_sockets/container_terminal/container_terminal.py`

 * *Files identical despite different names*

### Comparing `csle_rest_api-0.2.2/src/csle_rest_api.egg-info/PKG-INFO` & `csle_rest_api-0.2.3/src/csle_rest_api.egg-info/PKG-INFO`
...
### Comparing `csle_rest_api-0.2.2/src/csle_rest_api.egg-info/SOURCES.txt` & `csle_rest_api-0.2.3/src/csle_rest_api.egg-info/SOURCES.txt`
