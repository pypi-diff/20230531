# Comparing `tmp/s2aff-0.58.tar.gz` & `tmp/s2aff-0.59.tar.gz`
...
## Comparing `s2aff-0.58.tar` & `s2aff-0.59.tar`
...
### Comparing `s2aff-0.58/LICENSE` & `s2aff-0.59/LICENSE`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/README.md` & `s2aff-0.59/README.md`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/data/combine_gold.py` & `s2aff-0.59/data/combine_gold.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/data/download_latest_ror.py` & `s2aff-0.59/data/download_latest_ror.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/__init__.py` & `s2aff-0.59/s2aff/__init__.py`
...
### Comparing `s2aff-0.58/s2aff/consts.py` & `s2aff-0.59/s2aff/consts.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/data.py` & `s2aff-0.59/s2aff/data.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/features.py` & `s2aff-0.59/s2aff/features.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/file_cache.py` & `s2aff-0.59/s2aff/file_cache.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/lightgbm_helpers.py` & `s2aff-0.59/s2aff/lightgbm_helpers.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/model.py` & `s2aff-0.59/s2aff/model.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/ror.py` & `s2aff-0.59/s2aff/ror.py`
...
### Comparing `s2aff-0.58/s2aff/text.py` & `s2aff-0.59/s2aff/text.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/timo/integration_test.py` & `s2aff-0.59/s2aff/timo/integration_test.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff/timo/interface.py` & `s2aff-0.59/s2aff/timo/interface.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/s2aff.egg-info/SOURCES.txt` & `s2aff-0.59/s2aff.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/scripts/approximate_runtime_and_memory_usage.py` & `s2aff-0.59/scripts/approximate_runtime_and_memory_usage.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/scripts/evaluate_first_stage_ranker.py` & `s2aff-0.59/scripts/evaluate_first_stage_ranker.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/scripts/generate_lightgbm_training_data.py` & `s2aff-0.59/scripts/generate_lightgbm_training_data.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/scripts/train_lightgbm_reranker.py` & `s2aff-0.59/scripts/train_lightgbm_reranker.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/scripts/train_ner_model.py` & `s2aff-0.59/scripts/train_ner_model.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/scripts/update_openalex_works_counts.py` & `s2aff-0.59/scripts/update_openalex_works_counts.py`

 * *Files identical despite different names*

### Comparing `s2aff-0.58/setup.py` & `s2aff-0.59/setup.py`
