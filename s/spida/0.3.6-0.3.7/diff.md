# Comparing `tmp/spida-0.3.6.tar.gz` & `tmp/spida-0.3.7.tar.gz`
...
## Comparing `spida-0.3.6.tar` & `spida-0.3.7.tar`
...
### Comparing `spida-0.3.6/LICENSE` & `spida-0.3.7/LICENSE`

 * *Files identical despite different names*

### Comparing `spida-0.3.6/PKG-INFO` & `spida-0.3.7/PKG-INFO`
...
### Comparing `spida-0.3.6/README.md` & `spida-0.3.7/README.md`

 * *Files identical despite different names*

### Comparing `spida-0.3.6/setup.py` & `spida-0.3.7/setup.py`
...
### Comparing `spida-0.3.6/spida/stable_diffusion.py` & `spida-0.3.7/spida/stable_diffusion.py`

 * *Files identical despite different names*

### Comparing `spida-0.3.6/spida/utils/img.py` & `spida-0.3.7/spida/utils/img.py`
...
### Comparing `spida-0.3.6/spida/utils/misc.py` & `spida-0.3.7/spida/utils/misc.py`

 * *Files identical despite different names*

### Comparing `spida-0.3.6/spida/utils/net.py` & `spida-0.3.7/spida/utils/net.py`

 * *Files identical despite different names*

### Comparing `spida-0.3.6/spida.egg-info/PKG-INFO` & `spida-0.3.7/spida.egg-info/PKG-INFO`
