# Comparing `tmp/odh_core-0.1.20.tar.gz` & `tmp/odh_core-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "odh_core-0.1.20.tar", last modified: Wed May 31 15:18:27 2023, max compression
+gzip compressed data, was "odh_core-0.1.9.tar", last modified: Wed May  3 15:19:24 2023, max compression
```

## Comparing `odh_core-0.1.20.tar` & `odh_core-0.1.9.tar`

### file list

```diff
@@ -1,10 +1,9 @@
--rw-r--r--   0        0        0      171 2023-05-11 11:57:09.306140 odh_core-0.1.20/README.md
--rw-r--r--   0        0        0      483 2023-05-31 15:13:36.157137 odh_core-0.1.20/odh_core/__init__.py
--rw-r--r--   0        0        0     4742 2023-05-31 15:12:32.214219 odh_core-0.1.20/odh_core/graphql_client.py
--rw-r--r--   0        0        0     2056 2023-05-05 13:51:59.703502 odh_core-0.1.20/odh_core/logger.py
--rw-r--r--   0        0        0     4786 2023-05-31 12:40:53.590891 odh_core-0.1.20/odh_core/logging_settings.py
--rw-r--r--   0        0        0    15013 2023-05-31 12:40:53.590891 odh_core-0.1.20/odh_core/ms_odata.py
--rw-r--r--   0        0        0     2101 2023-05-05 13:52:03.193525 odh_core-0.1.20/odh_core/phonenumber.py
--rw-r--r--   0        0        0      852 2023-05-31 14:28:10.373413 odh_core-0.1.20/odh_core/ssn.py
--rw-r--r--   0        0        0     1161 2023-05-31 15:18:26.999419 odh_core-0.1.20/pyproject.toml
--rw-r--r--   0        0        0     1286 1970-01-01 00:00:00.000000 odh_core-0.1.20/PKG-INFO
...
### Comparing `odh_core-0.1.20/odh_core/logger.py` & `odh_core-0.1.9/odh_core/logger.py`

 * *Files identical despite different names*

### Comparing `odh_core-0.1.20/odh_core/logging_settings.py` & `odh_core-0.1.9/odh_core/logging_settings.py`
...
### Comparing `odh_core-0.1.20/odh_core/ms_odata.py` & `odh_core-0.1.9/odh_core/ms_odata.py`
...
### Comparing `odh_core-0.1.20/odh_core/phonenumber.py` & `odh_core-0.1.9/odh_core/phonenumber.py`

 * *Files identical despite different names*

### Comparing `odh_core-0.1.20/pyproject.toml` & `odh_core-0.1.9/pyproject.toml`
...
### Comparing `odh_core-0.1.20/PKG-INFO` & `odh_core-0.1.9/PKG-INFO`
