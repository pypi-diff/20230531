# Comparing `tmp/flask_cognito_lib-1.3.1.tar.gz` & `tmp/flask_cognito_lib-1.3.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flask_cognito_lib-1.3.1.tar", max compression
+gzip compressed data, was "flask_cognito_lib-1.3.2.tar", max compression
```

## Comparing `flask_cognito_lib-1.3.1.tar` & `flask_cognito_lib-1.3.2.tar`

### file list

```diff
@@ -1,14 +1,13 @@
--rw-r--r--   0        0        0     1072 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/LICENSE
--rw-r--r--   0        0        0     7653 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/README.md
--rw-r--r--   0        0        0     2261 2022-07-06 13:40:21.547296 flask_cognito_lib-1.3.1/pyproject.toml
--rw-r--r--   0        0        0       82 2022-07-06 13:40:21.535296 flask_cognito_lib-1.3.1/src/flask_cognito_lib/__init__.py
--rw-r--r--   0        0        0     4686 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/config.py
--rw-r--r--   0        0        0     6143 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/decorators.py
--rw-r--r--   0        0        0      384 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/exceptions.py
--rw-r--r--   0        0        0     6194 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/plugin.py
--rw-r--r--   0        0        0      326 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/services/__init__.py
--rw-r--r--   0        0        0     3510 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/services/cognito_svc.py
--rw-r--r--   0        0        0     5802 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/services/token_svc.py
--rw-r--r--   0        0        0     1124 2022-07-06 13:39:00.326806 flask_cognito_lib-1.3.1/src/flask_cognito_lib/utils.py
--rw-r--r--   0        0        0     8715 2022-07-06 13:41:47.563914 flask_cognito_lib-1.3.1/setup.py
--rw-r--r--   0        0        0     8958 2022-07-06 13:41:47.564615 flask_cognito_lib-1.3.1/PKG-INFO
...
### Comparing `flask_cognito_lib-1.3.1/LICENSE` & `flask_cognito_lib-1.3.2/LICENSE`

 * *Files identical despite different names*

### Comparing `flask_cognito_lib-1.3.1/README.md` & `flask_cognito_lib-1.3.2/README.md`
...
### Comparing `flask_cognito_lib-1.3.1/pyproject.toml` & `flask_cognito_lib-1.3.2/pyproject.toml`
...
@@ -67,15 +68,15 @@
 ...
 multi_line_output = 3
 line_length = 88
-known_first_party = ["flask_coginito_lib"]
...
### Comparing `flask_cognito_lib-1.3.1/src/flask_cognito_lib/config.py` & `flask_cognito_lib-1.3.2/src/flask_cognito_lib/config.py`

 * *Files identical despite different names*

### Comparing `flask_cognito_lib-1.3.1/src/flask_cognito_lib/decorators.py` & `flask_cognito_lib-1.3.2/src/flask_cognito_lib/decorators.py`
...
### Comparing `flask_cognito_lib-1.3.1/src/flask_cognito_lib/plugin.py` & `flask_cognito_lib-1.3.2/src/flask_cognito_lib/plugin.py`

 * *Files identical despite different names*

### Comparing `flask_cognito_lib-1.3.1/src/flask_cognito_lib/services/cognito_svc.py` & `flask_cognito_lib-1.3.2/src/flask_cognito_lib/services/cognito_svc.py`

 * *Files identical despite different names*

### Comparing `flask_cognito_lib-1.3.1/src/flask_cognito_lib/services/token_svc.py` & `flask_cognito_lib-1.3.2/src/flask_cognito_lib/services/token_svc.py`

 * *Files identical despite different names*

### Comparing `flask_cognito_lib-1.3.1/src/flask_cognito_lib/utils.py` & `flask_cognito_lib-1.3.2/src/flask_cognito_lib/utils.py`

 * *Files identical despite different names*

### Comparing `flask_cognito_lib-1.3.1/setup.py` & `flask_cognito_lib-1.3.2/PKG-INFO`
...
-
-install_requires = \
-['Flask>=2.0,<3.0', 'PyJWT[crypto]>=2.4,<3.0', 'requests>=2.0,<3.0']
-
-setup_kwargs = {
-    'name': 'flask-cognito-lib',
-    'version': '1.3.1',
