# Comparing `tmp/pypgstac-0.7.7.tar.gz` & `tmp/pypgstac-0.7.8.tar.gz`
...
### Comparing `pypgstac-0.7.7/pypgstac/migrations/pgstac.0.2.5.sql` & `pypgstac-0.7.8/pypgstac/migrations/pgstac.0.2.5.sql`
