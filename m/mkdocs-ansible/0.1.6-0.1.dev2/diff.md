# Comparing `tmp/mkdocs-ansible-0.1.6.tar.gz` & `tmp/mkdocs-ansible-0.1.dev2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mkdocs-ansible-0.1.6.tar", last modified: Wed May 31 16:47:05 2023, max compression
+gzip compressed data, was "mkdocs-ansible-0.1.dev2.tar", last modified: Fri Mar 10 12:52:02 2023, max compression
```

## Comparing `mkdocs-ansible-0.1.6.tar` & `mkdocs-ansible-0.1.dev2.tar`

### file list

```diff
@@ -1,48 +1,48 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.618164 mkdocs-ansible-0.1.6/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/.config/
--rw-r--r--   0 runner    (1001) docker     (123)      470 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.config/dictionary.txt
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.config/requirements-test.txt
--rw-r--r--   0 runner    (1001) docker     (123)      355 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.config/requirements.in
--rw-r--r--   0 runner    (1001) docker     (123)     1291 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.config/requirements.txt
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/.github/
--rw-r--r--   0 runner    (1001) docker     (123)       26 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/CODEOWNERS
--rw-r--r--   0 runner    (1001) docker     (123)      373 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/dependabot.yml
--rw-r--r--   0 runner    (1001) docker     (123)       73 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/release-drafter.yml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/.github/workflows/
--rw-r--r--   0 runner    (1001) docker     (123)      244 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/workflows/ack.yml
--rw-r--r--   0 runner    (1001) docker     (123)      248 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/workflows/push.yml
--rw-r--r--   0 runner    (1001) docker     (123)      969 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/workflows/release.yml
--rw-r--r--   0 runner    (1001) docker     (123)     4678 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.github/workflows/tox.yml
--rw-r--r--   0 runner    (1001) docker     (123)       96 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.gitignore
--rw-r--r--   0 runner    (1001) docker     (123)     4198 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.pre-commit-config.yaml
--rw-r--r--   0 runner    (1001) docker     (123)      439 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.readthedocs.yml
--rw-r--r--   0 runner    (1001) docker     (123)      281 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/.yamllint
--rw-r--r--   0 runner    (1001) docker     (123)     1704 2023-05-31 16:47:05.618164 mkdocs-ansible-0.1.6/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      475 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/cspell.config.yaml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/docs/
--rw-r--r--   0 runner    (1001) docker     (123)      691 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/docs/README.md
--rw-r--r--   0 runner    (1001) docker     (123)     2374 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/mkdocs.yml
--rw-r--r--   0 runner    (1001) docker     (123)     2059 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-31 16:47:05.618164 mkdocs-ansible-0.1.6/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.610163 mkdocs-ansible-0.1.6/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/src/mkdocs_ansible/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/src/mkdocs_ansible/.icons/
--rw-r--r--   0 runner    (1001) docker     (123)     1047 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/.icons/logo.svg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.618164 mkdocs-ansible-0.1.6/src/mkdocs_ansible/.overrides/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/.overrides/.gitignore
--rw-r--r--   0 runner    (1001) docker     (123)      196 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      160 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/_version.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.610163 mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.618164 mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/
--rw-r--r--   0 runner    (1001) docker     (123)    15406 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/favicon.ico
--rw-r--r--   0 runner    (1001) docker     (123)    10993 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/logo.png
--rw-r--r--   0 runner    (1001) docker     (123)     1047 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/logo.svg
--rw-r--r--   0 runner    (1001) docker     (123)      770 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible/mkdocs_theme.yml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-31 16:47:05.614163 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1704 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      967 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       41 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)     1402 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       15 2023-05-31 16:47:05.000000 mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)     3242 2023-05-31 16:46:46.000000 mkdocs-ansible-0.1.6/tox.ini
...
### Comparing `mkdocs-ansible-0.1.6/.config/requirements.txt` & `mkdocs-ansible-0.1.dev2/.config/requirements.txt`
...
### Comparing `mkdocs-ansible-0.1.6/.github/workflows/release.yml` & `mkdocs-ansible-0.1.dev2/.github/workflows/release.yml`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/.github/workflows/tox.yml` & `mkdocs-ansible-0.1.dev2/.github/workflows/tox.yml`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/.pre-commit-config.yaml` & `mkdocs-ansible-0.1.dev2/.pre-commit-config.yaml`
...
### Comparing `mkdocs-ansible-0.1.6/PKG-INFO` & `mkdocs-ansible-0.1.dev2/PKG-INFO`
...
### Comparing `mkdocs-ansible-0.1.6/docs/README.md` & `mkdocs-ansible-0.1.dev2/docs/README.md`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/mkdocs.yml` & `mkdocs-ansible-0.1.dev2/mkdocs.yml`
...
### Comparing `mkdocs-ansible-0.1.6/pyproject.toml` & `mkdocs-ansible-0.1.dev2/pyproject.toml`
...
### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible/.icons/logo.svg` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible/.icons/logo.svg`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/favicon.ico` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible/assets/images/favicon.ico`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/logo.png` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible/assets/images/logo.png`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible/assets/images/logo.svg` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible/assets/images/logo.svg`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible/mkdocs_theme.yml` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible/mkdocs_theme.yml`
...
### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/PKG-INFO` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible.egg-info/PKG-INFO`
...
### Comparing `mkdocs-ansible-0.1.6/src/mkdocs_ansible.egg-info/SOURCES.txt` & `mkdocs-ansible-0.1.dev2/src/mkdocs_ansible.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `mkdocs-ansible-0.1.6/tox.ini` & `mkdocs-ansible-0.1.dev2/tox.ini`
