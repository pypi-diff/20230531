# Comparing `tmp/thsquant-0.2.2.tar.gz` & `tmp/thsquant-0.2.3.tar.gz`
...
## Comparing `thsquant-0.2.2.tar` & `thsquant-0.2.3.tar`
...
### Comparing `thsquant-0.2.2/LICENSE.txt` & `thsquant-0.2.3/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/PKG-INFO` & `thsquant-0.2.3/PKG-INFO`
...
### Comparing `thsquant-0.2.2/setup.py` & `thsquant-0.2.3/setup.py`
...
### Comparing `thsquant-0.2.2/thsquant/convert_llama_weights_to_hf.py` & `thsquant-0.2.3/thsquant/convert_llama_weights_to_hf.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/gptq.py` & `thsquant-0.2.3/thsquant/gptq.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/llama.py` & `thsquant-0.2.3/thsquant/llama.py`
...
### Comparing `thsquant-0.2.2/thsquant/llama_inference.py` & `thsquant-0.2.3/thsquant/llama_inference.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/llama_inference_offload.py` & `thsquant-0.2.3/thsquant/llama_inference_offload.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/neox.py` & `thsquant-0.2.3/thsquant/neox.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/opt.py` & `thsquant-0.2.3/thsquant/opt.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/quant/custom_autotune.py` & `thsquant-0.2.3/thsquant/quant/custom_autotune.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/quant/fused_attn.py` & `thsquant-0.2.3/thsquant/quant/fused_attn.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/quant/fused_mlp.py` & `thsquant-0.2.3/thsquant/quant/fused_mlp.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/quant/quant_linear.py` & `thsquant-0.2.3/thsquant/quant/quant_linear.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/quant/quantizer.py` & `thsquant-0.2.3/thsquant/quant/quantizer.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/quant/triton_norm.py` & `thsquant-0.2.3/thsquant/quant/triton_norm.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/utils/datautils.py` & `thsquant-0.2.3/thsquant/utils/datautils.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/utils/export.py` & `thsquant-0.2.3/thsquant/utils/export.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant/utils/modelutils.py` & `thsquant-0.2.3/thsquant/utils/modelutils.py`

 * *Files identical despite different names*

### Comparing `thsquant-0.2.2/thsquant.egg-info/PKG-INFO` & `thsquant-0.2.3/thsquant.egg-info/PKG-INFO`
...
### Comparing `thsquant-0.2.2/thsquant.egg-info/SOURCES.txt` & `thsquant-0.2.3/thsquant.egg-info/SOURCES.txt`
